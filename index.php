...
<html lang="en">
  <head>
    ...
    <title>Bryce Industries Careers</title>
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">Bryce Industries</a>
            </div>
          ...
          <div class="row">
            <div class="col-md-12 wow fadeIn delay-05s">
              <div class="banner-text">
                <h2>Welcome to <span>Bryce Careers</span></h2>
                <p>Move to the top of the career Mountain</p>
              </div>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="contact-sec text-center">
            <h2>Want To <span class="deco">Submit</span> your CV?</h2>
...
?>
            ...
            <form action="index.php" enctype="multipart/form-data" method="post" role="form" class="contactForm">

         
             <div class="form-group">
  
    <input  name="uploadedfile" type="file">
    <p class="help-block">Upload your CV Here</p>
  </div>
                <div class="form-group">
                    <input type="text" name="name" class="form-control" id="name" placeholder="Your Name" value="John" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                    <div class="validation"></div>
                </div>
                <div class="form-group">
                    <input type="email" class="form-control" name="email" value="john@tester.net" id="email" placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email" />
                    <div class="validation"></div>
                </div>
                <div class="form-group">
  ...
  <section id="portfolio" class="section-padding wow fadeInUp delay-05s">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="title text-center">Work for us</h2>
        </div>
        <div class="col-md-12">
